<?php
	//--------------------------------------------------------------------------------
	//	RSS2Writer (v2.0) and sample controller
	//
	//	(c) Copyright Daniel Soutter
	//	Written on the 13th April 2009
	//  Update Jan 2010: improved useability and functionality
	//
	...
	//	my blog (above).
	//
	//  For more information about the class and it's uses, including examples
...
class RSS2Writer
{
	...
	* Returns:		Void
	**********************************************************************************/
	function __construct($title, $description, $link, $indent = 6)	//Constructor
	{
